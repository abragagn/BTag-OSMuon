...
varListTest3 = [
    ...
    ,('muoDrB', 'F')
    ,('muoPFIso', 'F')
    ,('muoJetPt != -1 ? muoJetPt : muoConePt', 'F')
    ,('muoJetPt != -1 ? muoJetPtRel : muoConePtRel', 'F')
    ,('muoJetPt != -1 ? muoJetDr : muoConeDr', 'F')
    ,('muoJetPt != -1 ? muoJetEnergyRatio : muoConeEnergyRatio', 'F')
    ,('muoJetCSV', 'F')
    ,('muoJetDFprob', 'F')
    ,('muoJetPt != -1 ? muoJetSize : muoConeSize', 'I')
    ,('muoQCone', 'F')
    ]
